...
import Pizza from "../images/pizza-slid-img.png"
 ...
 import Tomato from "../images/tamato.png"
 import Cucumber from "../images/cucumber.png"
 import Romanie from "../images/romanie.png"
...
const MenuItems = [
  ...
  const Items = [
    {
      ...
      disc:"Lorem ipsum dolor sit amet. Ut voluptatem enim eum ut.....",
      imgSrc:Lade,
       name: "Burger Bistro",
      ratings: 4.2,
      price: "119",
  ...
  const Hotel = [
    {
      hotelId:"hotel01",
      itemId:"buger01",
      distance:"92 meter Away",
      name:"ROstAnga",
      subname:"Angsgatan 74",
      botname:"Angsgatan 70",
      imgSrc: Lade,
      ratings:44.2
     },
     {
     ...
     },
     {
      ...
      distance:"92 meter Away",
      name:"La'De Kitchen ",
      imgSrc: "http://vignette1.wikia.nocookie.net/ridiculoushist/images/b/b8/KFC_logo.png",
      ratings:44.2
     },
     {
      hotelId:"hotel02",
      ...
      distance:"92 meter Away",
      name:"La'De Kitchen ",
      imgSrc: "http://res.cloudinary.com/simpleview/image/upload/v1438123960/clients/grandrapids/file_bcf11a47-7451-464f-8c4d-c9d3e85e9146.png",
      "minCharge":"5.00 LE",
      ratings:44.2
     },
     {
  ...
  export { MenuItems, Items ,Hotel ,vegItems,vegitable};